...
{
    public class TestCiblerJoueurUneCarte
    {
        public TestCiblerJoueurUneCarte()
        {
            ...
            Console.WriteLine("Le joueur ciblé n'a plus qu'une carte \n");
            Console.WriteLine("Le joueur 1 va cibler le joueur 2 \n");
            ...
            partieClient.ciblerJoueurQUUneCarte(id);
