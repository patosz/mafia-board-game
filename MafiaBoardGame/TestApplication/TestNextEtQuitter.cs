...
{
    public class TestNextEtQuitter
    {
        public TestNextEtQuitter()
        {
            ...
            //Maintenant le Joueur 2 nous quitte
            partieClient.quitterPartie(2);

            Console.WriteLine("Le joueur 2 nous quitte (la mafia est passé par la) \n");
            Console.WriteLine("Apres que le Joueur 2 soit parti le next envoie  => Joueur 3 \n");
            joueurSuivant = partieClient.next();
            Console.WriteLine("Pseudo : " + joueurSuivant.Joueur.Pseudo + "  ID JoueurPartieCourant : " + joueurSuivant.Id + "Ordre de joueur : " + joueurSuivant.OrdreJoueur);

            Console.WriteLine("On peut voir que le numéro d'ordre se met à jour \n");
